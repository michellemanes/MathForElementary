...
\begin{center}
\includegraphics[height=3cm]{../Pictures/PlaceValuePics/dots1}
\end{center}

Here are some boxes:

\begin{center}
\includegraphics[height=1.5cm]{../Pictures/PlaceValuePics/boxes1}
\end{center}
...
\begin{center}
\includegraphics[height=1.5cm]{../Pictures/PlaceValuePics/9dots1}
\end{center}
Two dots in that box explode and become one dot in the box to the left.
\begin{center}
\includegraphics[height=4.5cm]{../Pictures/PlaceValuePics/9dots2}
\end{center}
Since there are more than two dots in the rightmost box, it can happen again.
\begin{center}
\includegraphics[height=4.5cm]{../Pictures/PlaceValuePics/9dots3}
\end{center}
And again!
\begin{center}
\includegraphics[height=3cm]{../Pictures/PlaceValuePics/9dots4}
\end{center}
Hey, now we have more than two dots in the second box, so those can explode and move!
\begin{center}
\includegraphics[height=3cm]{../Pictures/PlaceValuePics/9dots5}
\end{center}
And the rightmost box still has more than two dots.
\begin{center}
\includegraphics[height=3cm]{../Pictures/PlaceValuePics/9dots6}
\end{center}
Keep going, until no box has two dots.
\begin{center}
\includegraphics[height=3cm]{../Pictures/PlaceValuePics/9dots7}

\includegraphics[height=3cm]{../Pictures/PlaceValuePics/9dots8}
\end{center}
...
\begin{center}
\includegraphics[height=7cm]{../Pictures/PlaceValuePics/7dots}
\end{center}
...
\begin{center}
\includegraphics[height=8cm]{../Pictures/PlaceValuePics/15dots}
\end{center}
...
\begin{center}
\includegraphics[height=1.5cm]{../Pictures/PlaceValuePics/binary1}
\end{center}
If each of the original dots is worth ``one,'' then the single dot on the left must be worth two.
\begin{center}
\includegraphics[height=2cm]{../Pictures/PlaceValuePics/binary2}
\end{center}
But we also have two dots in the box of value 2 is worth 1 dot in the box just to the left\dots
\begin{center}
\includegraphics[height=2cm]{../Pictures/PlaceValuePics/binary3}
\end{center}
So that next box must be worth two 2s, which is four!
\begin{center}
\includegraphics[height=2cm]{../Pictures/PlaceValuePics/binary4}
\end{center}
And two of these fours make eight.
\begin{center}
\includegraphics[height=2.1cm]{../Pictures/PlaceValuePics/binary5}
\end{center}


\begin{example}
We said earlier that the $1 \leftarrow 2$ code for nine dots was 1001. LetÕs check:
\begin{center}
\includegraphics[height=2.1cm]{../Pictures/PlaceValuePics/9inbinary}
\end{center}
\[
...
\begin{center}
\includegraphics[height=2.1cm]{../Pictures/PlaceValuePics/13inbinary}
\end{center}
\[
...
\begin{center}
\includegraphics[height=2.1cm]{../Pictures/PlaceValuePics/base3_1}
\end{center}
...
because
\begin{center}
\includegraphics[height=2.5cm]{../Pictures/PlaceValuePics/15base3}
\end{center}
\[
9 + 2\cdot 3 = 9+6 = 15.
\]
...
\begin{center}
\includegraphics[height=2cm]{../Pictures/PlaceValuePics/base4system}
\end{center}
...
What is the value of each box?
\begin{center}
\includegraphics[height=2cm]{../Pictures/PlaceValuePics/base10system}
\end{center}
...
\begin{center}
\includegraphics[height=1.5cm]{../Pictures/PlaceValuePics/adventure1}
\end{center}
